 ...
 */
class getInfoCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\InfoCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\InfoCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'InfoCategoryRepository.php';

        return $container->privates['App\\Repository\\InfoCategoryRepository'] = new \App\Repository\InfoCategoryRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
