 ...
 */
class getMapRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MapRepository' shared autowired service.
     *
     * @return \App\Repository\MapRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MapRepository.php';

        return $container->privates['App\\Repository\\MapRepository'] = new \App\Repository\MapRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
