 ...
 */
class getPlaylistCategoryRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\PlaylistCategoryRepository' shared autowired service.
     *
     * @return \App\Repository\PlaylistCategoryRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'PlaylistCategoryRepository.php';

        return $container->privates['App\\Repository\\PlaylistCategoryRepository'] = new \App\Repository\PlaylistCategoryRepository(($container->services['doctrine'] ?? $container->load('getDoctrineService')));
    }
}
